            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-5 rounded-2xl" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)' }}>
                ...
                <p className="text-white/50 text-sm leading-relaxed">
                  Дополнительный ключ, привязанный к вашему автомобилю. Полностью функциональный — открытие/закрытие, запуск двигателя, иммобилайзер. 
              ...
              <div className="p-5 rounded-2xl" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)' }}>
                ...
                <p className="text-white/50 text-sm leading-relaxed">
                  Оригинальный ключ BMW с полным набором функций. Включает дистанционное управление, 
