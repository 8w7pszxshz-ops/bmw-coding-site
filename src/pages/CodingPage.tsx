          ...
          <div className="mb-12">
            ...
            <div className="space-y-4">
              {[
                ...
                { q: 'Безопасно ли кодирование для автомобиля?', a: 'Да. Кодирование — это изменение конфигурации модулей, аналогичное тому, что делает дилер при установке дополнительных опций.' },
