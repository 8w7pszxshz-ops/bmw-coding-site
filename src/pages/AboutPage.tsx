...
export default function AboutPage() {
  ...
  const advantages = [
    ...
    { icon: 'Undo2', title: 'Гарантия отката', desc: 'Сохраняем оригинальную прошивку. Возврат к стоку бесплатно в любой момент. Без вопросов и условий.' },
          ...
          <div className="mb-12">
            ...
            <div className="space-y-4">
              {[
                ...
                { q: 'Работаете ли вы с другими марками?', a: 'Нет, только BMW. Это позволяет нам быть настоящими экспертами и гарантировать качество работы.' },
                { q: 'Нужно ли записываться заранее?', a: 'Да, рекомендуем записаться за 1-2 дня. Пишите в Telegram — подберём удобное время.' },
                { q: 'Даёте ли вы гарантию?', a: 'Да. Гарантия возврата к стоковой прошивке — бесплатно и навсегда. Если что-то не устроит — вернём как было без вопросов.' },
              ].map((faq, i) => (
