...
export default function AboutPage() {
  ...
  const advantages = [
    ...
    { icon: 'CreditCard', title: 'Оплата по результату', desc: 'Никакой предоплаты. Не сделали — денег не взяли. Если что-то не получилось по объективным причинам — никаких платежей.' },
  ];
          ...
          <div className="mb-12">
            ...
            <div className="space-y-3">
              {[
                ...
                { step: '05', text: 'Проверяем результат вместе — не сделали, денег не взяли' },
              ].map((item) => (
