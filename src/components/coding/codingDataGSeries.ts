export const gSeriesOptions = [
  ...
  // Комфорт
  { id: 'g_mirror_dim', name: 'Чувствительность затемнения зеркал', category: 'comfort', description: 'Настройка для тонировки', icon: 'Maximize2', series: 'G' as const },
  { id: 'g_wiper_count', name: 'Количество взмахов стеклоочистителей', category: 'comfort', description: 'Регулировка числа взмахов', icon: 'Wind', series: 'G' as const },
  { id: 'g_trunk_close_fast', name: 'Закрытие багажника без задержки', category: 'comfort', description: 'Быстрое закрытие без долгого удержания (HRFM)', icon: 'Package', series: 'G' as const },
  { id: 'g_window_comfort', name: 'Закрывание стеклоподъемников', category: 'comfort', description: 'Без удержания кнопки при открытой двери', icon: 'Square', series: 'G' as const },
  { id: 'g_seat_heat_dist', name: 'Распределение подогрева', category: 'comfort', description: 'Спина/колени/полностью (только водитель в G20)', icon: 'Thermometer', series: 'G' as const },
  { id: 'g_seat_auto_heat', name: 'Авто подогрев/вентиляция сидений', category: 'comfort', description: 'Управление в меню климата (VO-кодирование)', icon: 'Thermometer', series: 'G' as const },
  ...
  { id: 'g_sounds_bmw', name: 'Звуковые предупреждения BMW', category: 'multimedia', description: 'Системные звуки авто', icon: 'Volume2', series: 'G' as const },
  ...
  { id: 'g_sport_color_change', name: 'Цвета спортивных приборов', category: 'multimedia', description: 'Оранжевый → серый M-стиль', icon: 'Palette', series: 'G' as const },
  { id: 'g_sound_styles', name: 'Стили звукового оформления', category: 'multimedia', description: 'i8, Rolls Royce, Mini', icon: 'Volume2', series: 'G' as const },
