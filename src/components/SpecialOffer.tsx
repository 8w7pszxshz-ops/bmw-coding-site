...
const offers = [
  ...
  },
  {
    ...
    description: 'Секрет в технологиях: новый ключ BMW за 30 минут без разбора автомобиля. Полноценная копия для G-серии без ожидания из-за границы и риска для электроники.',
    oldPrice: '40 000 ₽',
    newPrice: '25 000 ₽',
    discount: '-37%',
