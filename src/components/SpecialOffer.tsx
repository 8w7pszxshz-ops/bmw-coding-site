...
const offers = [
  ...
  },
  {
    ...
    description: 'Секрет в технологиях: ваш новый ключ BMW за 30 минут без разбора автомобиля. Многие уверены, что новый ключ для G-серии — это либо долгое ожидание из-за границы, либо риск для электроники. Мы ломаем эти стереотипы в 2026 году, предлагая создание полноценной копии на совершенно ином уровне.',
    oldPrice: '40 000 ₽',
    newPrice: '25 000 ₽',
    discount: '-37%',
