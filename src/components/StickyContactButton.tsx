    ...
    <MobileOnly>
      <div className="fixed bottom-6 right-4 z-50">
        {isExpanded && (
          <div className="absolute bottom-16 right-0 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-2xl shadow-2xl p-3 mb-2 animate-in fade-in slide-in-from-bottom-4 duration-200">
            ...
            >
              ...
              <span className="text-white font-light text-sm whitespace-nowrap">+7 (926) 555-88-99</span>
            </a>
            
            <a 
              href="https://t.me/rebornbmw"
        ...
        <button
          ...
          className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95"
          style={{
